...
public class d {
   ...
   public void a() {
      ...
      try {
         this.b = (HIDDevice)(new E(3, 100)).a(new e(this));
   ...
   private HIDDevice a(int var1, int var2, String var3) {
   ...
   private void a(int var1, short[] var2, int var3) {
      this.a(var1, var2, var3, 16);
   }

   private void a(int var1, short[] var2, int var3, int var4) {
   ...
   private boolean a(byte[] var1, byte[] var2, int var3) {
      this.b.write(var1);
   ...
   // $FF: synthetic method
   static HIDDevice a(d var0, int var1, int var2, String var3) {
