...
public class p {
   ...
   public p(JFrame var1, ImageDoodad.f var2) {
      ...
      var3.setBackground(com.nowcomputing.f.h.a);
   ...
   public void b() {
      this.d().removeAll();
      z var1 = new z();
      var1.a(com.nowcomputing.f.a("PIXELFURNACE"));
      var1.a(true);
      var1.b(true);
      var1.c(false);
   ...
   private void a(JPanel var1) {
      ...
      this.j.setBackground(com.nowcomputing.f.h.a);
      var1.add(this.j);
   ...
   private JPanel o() {
      ...
      JLabel var4 = new JLabel(com.nowcomputing.f.a("MAIN_HEADING"));
      var4.setForeground(Color.WHITE);
      var4.setFont(com.nowcomputing.f.q.j);
      var4.setAlignmentX(0.5F);
      var4.setHorizontalAlignment(0);
      var3.add(var4);
      JLabel var5 = new JLabel(com.nowcomputing.f.a("SUB_HEADING"));
      var5.setForeground(Color.WHITE);
      var5.setFont(com.nowcomputing.f.q.k);
