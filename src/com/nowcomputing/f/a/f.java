...
public class f extends JPanel {
   ...
   f(p var1) {
      ...
      this.m = new JCheckBox(com.nowcomputing.f.a("SCROLL_OFF"));
      this.n = new JCheckBox(com.nowcomputing.f.a("SCROLL_OFF"));
      JPanel var2 = new JPanel();
      var2.setBounds(78, 62, 644, 486);
      var2.setLayout((LayoutManager)null);
      var2.setBackground(com.nowcomputing.f.h.r);
      this.add(var2);
      this.a(var2);
      JPanel var3 = new JPanel();
      var3.setBackground(com.nowcomputing.f.h.q);
   ...
   private void a(JPanel var1) {
      ...
      this.b = new JRadioButton(com.nowcomputing.f.a("SCROLL_TEXT"));
      this.b.setSelected(true);
      this.b.setOpaque(false);
      var2.add(this.b);
      this.c = new JRadioButton(com.nowcomputing.f.a("SCROLL_IMAGE"));
      this.c.setOpaque(false);
      var2.add(this.c);
      this.d = new JRadioButton(com.nowcomputing.f.a("LOAD_GIF"));
      this.d.setOpaque(false);
      var2.add(this.d);
      this.e = new JRadioButton(com.nowcomputing.f.a("CREATE_ANIM"));
   ...
   private JPanel a(JRadioButton var1) {
      ...
      var2.add(this.f);
      this.k = new JComboBox(com.nowcomputing.a.d.a());
   ...
   private JPanel b(JRadioButton var1) {
      ...
      this.h.setFont(com.nowcomputing.f.q.x);
      this.h.setBounds(195, 48, 120, 26);
      var2.add(this.h);
      JButton var3 = new JButton(com.nowcomputing.f.a("OPEN_BUTTON"));
      var3.setFont(com.nowcomputing.f.q.x);
      var3.setBounds(86, 50, 100, 26);
      var2.add(var3);
      var3.addActionListener(new j(this));
      this.l = new JComboBox(com.nowcomputing.a.d.a());
   ...
   private JPanel c(JRadioButton var1) {
      ...
      this.j.setFont(com.nowcomputing.f.q.x);
   ...
   private JPanel a() {
      ...
      var1.setBackground(com.nowcomputing.f.h.q);
      var1.setLayout(new FlowLayout(1, 30, 20));
      var1.setBounds(0, 404, 644, 104);
      JButton var2 = new JButton(com.nowcomputing.f.a("CANCEL"));
      var1.add(var2);
      var2.setFont(com.nowcomputing.f.q.w);
      var2.addActionListener(new l(this));
      JButton var3 = new JButton(com.nowcomputing.f.a("GO_BUTTON"));
      var1.add(var3);
      var3.setFont(com.nowcomputing.f.q.w);
   ...
   private JPanel e(JRadioButton var1) {
      JPanel var2 = new JPanel();
      var2.setBackground(com.nowcomputing.f.h.q);
      var2.setLayout((LayoutManager)null);
      var1.setBounds(65, 25, 280, 20);
      var1.setFont(com.nowcomputing.f.q.w);
      var1.setForeground(com.nowcomputing.f.h.s);
      var2.add(var1);
      return var2;
   }
   ...
   private JPanel a(JComboBox var1, JCheckBox var2) {
      ...
      var3.add(var4);
      JLabel var5 = new JLabel(com.nowcomputing.f.a("SCROLL_DIRECTION"));
      var5.setBounds(2, 25, 260, 20);
      var5.setFont(com.nowcomputing.f.q.x);
      var5.setForeground(com.nowcomputing.f.h.s);
      var4.add(var5);
      var1.setBounds(0, 50, 100, 26);
      var1.setFont(com.nowcomputing.f.q.x);
      var4.add(var1);
      ...
      var2.setFont(com.nowcomputing.f.q.x);
      var2.setForeground(com.nowcomputing.f.h.s);
   ...
   private void b() {
      if (this.b.isSelected()) {
         ...
         if (!var1.equals("")) {
            this.a.a(var1, (com.nowcomputing.a.d)this.k.getSelectedItem(), this.m.isSelected());
         }
         ...
         if (this.c.isSelected()) {
            ...
            if (var5 != null) {
               ...
               if (var2 != o.a && var2 != o.c) {
                  if (var2 == o.b) {
                     N.a((Component)this, (String[])(new String[]{com.nowcomputing.f.a("ERROR_WRONG_FORMAT_HEADER"), com.nowcomputing.f.a("ERROR_NOT_STATIC_IMAGE_1"), com.nowcomputing.f.a("ERROR_NOT_STATIC_IMAGE_2")}));
                  } else {
                     N.a((Component)this, (String[])(new String[]{com.nowcomputing.f.a("ERROR_WRONG_FORMAT_HEADER"), com.nowcomputing.f.a("ERROR_WRONG_FORMAT"), com.nowcomputing.f.a("ERROR_NOT_STATIC_IMAGE_2")}));
                  }
               } else {
                  this.a.a(var5, (com.nowcomputing.a.d)this.l.getSelectedItem(), this.n.isSelected());
                  this.a.c(false);
               }
            }
            ...
            if (var5 != null) {
               ...
               if (var2 != o.a && var2 != o.b) {
                  N.a((Component)this, (String[])(new String[]{com.nowcomputing.f.a("ERROR_WRONG_FORMAT_HEADER"), com.nowcomputing.f.a("ERROR_WRONG_FORMAT"), com.nowcomputing.f.a("ERROR_NOT_GIF")}));
               } else {
                  try {
                     this.a.a(var5);
