...
public class a extends JDialog implements ActionListener, MouseListener, MouseMotionListener {
   ...
   public com.nowcomputing.a a() {
      return this.b;
   }

   public void a(File var1) {
      this.b = com.nowcomputing.a.a(var1);
      this.c(this.b.b());
      this.b(this.b.a());
      this.h = 0;
      this.a(this.h);
   ...
   private void B() {
      ...
      var2.addMouseListener(new b(this));
      var2.setBackground(com.nowcomputing.f.h.d);
   ...
   private JPanel E() {
      ...
      var1.setBackground(com.nowcomputing.f.h.f);
   ...
   private Component G() {
      ...
      JButton var4 = new JButton(com.nowcomputing.f.a("DONE"));
      var4.setFont(com.nowcomputing.f.q.y);
   ...
   private Component H() {
      ...
      var4.setToolTipText(com.nowcomputing.f.a("NUMBER_OF_FRAMES"));
      var4.setFont(com.nowcomputing.f.q.z);
      ...
      var14.setToolTipText(com.nowcomputing.f.a("FPS"));
      var14.setFont(com.nowcomputing.f.q.z);
   ...
   private Component I() {
      ...
      this.g.setFont(com.nowcomputing.f.q.z);
      ...
      this.n.setBackground(com.nowcomputing.f.h.f);
   ...
   private void K() {
      JMenu var1 = new JMenu(com.nowcomputing.f.a("FILE_MENU"));
      var1.setMnemonic(70);
      this.f.add(var1);
   ...
   private void L() {
      JMenu var1 = new JMenu(com.nowcomputing.f.a("ANIMATION_MENU"));
      var1.setMnemonic(65);
      this.f.add(var1);
   ...
   private void M() {
      JMenu var1 = new JMenu(com.nowcomputing.f.a("EDIT_MENU"));
      var1.setMnemonic(69);
      this.f.add(var1);
   ...
   public void a(k var1) {
      this.b = new com.nowcomputing.a(var1.a());
      this.a(var1.b());
   }
   ...
   // $FF: synthetic method
   static com.nowcomputing.a a(a var0) {
      return var0.b;
   }

   // $FF: synthetic method
   static JSlider b(a var0) {
      return var0.g;
   }
