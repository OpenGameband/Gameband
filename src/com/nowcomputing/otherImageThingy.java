...
public class otherImageThingy {
   ...
   public otherImageThingy(int var1, int var2) {
      this.b = var2;
   ...
   public otherImageThingy(otherImageThingy var1) {
      this.b = var1.b();
   ...
   public otherImageThingy(ArrayList var1, int var2) {
      this.a = var1;
      this.b = var2;
   }

   public otherImageThingy(ArrayList var1) {
   ...
   public static otherImageThingy a(File var0) throws IOException {
      q var1 = new q();
      if (var1.a(var0.getPath()) != 0) {
         throw new IOException();
      } else {
         otherImageThingy var2 = new otherImageThingy(var1.c());
         return var2;
      }
   }

   public void b(File var1) throws IOException {
      ImageWriter var2 = d();
   ...
   private static ImageWriter d() throws IIOException {
